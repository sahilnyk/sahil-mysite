  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Bowlby+One&family=Cardo:ital,wght@0,400;0,700;1,400&family=Inria+Serif:ital,wght@0,300;0,400;0,700;1,300;1,400;1,700&family=Source+Code+Pro:wght@300;400;500;600&display=swap"
          rel="stylesheet"
        />
      </head>
